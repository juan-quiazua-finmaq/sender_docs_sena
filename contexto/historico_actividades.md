...
- Se instruyo al aprendiz para realizar aprendizaje sobre arquitecturas de diseño para software de calidad
...
## Bitacora numero 4 - (20/05/2026 al 03/06/2026)
- El aprendiz se le asigno una tarea que busca beneficiar el Área de cartera, por medio de una lambda y el correcto procesamiento de datos siguiendo el patron (ETL)
- Al aprendiz se le instruyo en arquitectura de datos, ciencia de datos, y estandares como el DAMA.
